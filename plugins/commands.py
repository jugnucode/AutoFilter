...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('⚡ UᎮDΛTΞS ⚡', url='https://t.me/cyberstainbot')
            ],
            [
                InlineKeyboardButton('⚡ SUBSCᏒIBΞ ⚡', url=f"https://telegram.me/cyberstainbot"),
            ],
            [
        ...
        await asyncio.sleep(2) # 😢 https://github.com/AutoFiltermariaTG/AutoFilterMaria/blob/master/plugins/p_ttishow.py#L17 😬 wait a bit, before checking.
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ SUBSCᏒIBΞ ⚡', url='https://telegram.me/cyberstainbot'),
            InlineKeyboardButton('🤖 UᎮDΛTΞS 🤖', url='https://t.me/cyberstainbot')
            ],[
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('sᴜʙsᴄʀɪʙᴇ', url='https://telegram.me/cyberstainbot') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
...
async def delete(bot, message):
    ...
    if result.deleted_count:
        ...
        if result.deleted_count:
            ...
            # files indexed before https://github.com/AutoFiltermariaTG/AutoFilterMaria/commit/f3d2a1bcb155faf44178e5d7a685a1b533e714bf#diff-86b613edf1748372103e94cacff3b578b36b698ef9c16817bb98fe9ef22fb669R39 
